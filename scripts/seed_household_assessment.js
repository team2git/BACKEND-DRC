...
const buildTemplateAndMapping = () => {
  ...
  const targetPaths = [
    // Identity & Location
    { q: 'subcity', t: 'household_profile.identity_location.subcity', cast: 'direct' },
    { q: 'woreda', t: 'household_profile.identity_location.woreda', cast: 'direct' },
    { q: 'kebele', t: 'household_profile.identity_location.kebele', cast: 'direct' },
    { q: 'block', t: 'household_profile.identity_location.block', cast: 'direct' },
    { q: 'house_no', t: 'household_profile.identity_location.house_no', cast: 'direct' },
    { q: 'gps_latitude', t: 'household_profile.identity_location.gps_latitude', cast: 'cast_number' },
    { q: 'gps_longitude', t: 'household_profile.identity_location.gps_longitude', cast: 'cast_number' },
    { q: 'enumerator_name', t: 'household_profile.identity_location.enumerator_name', cast: 'direct' },
    { q: 'survey_date', t: 'household_profile.identity_location.survey_date', cast: 'direct' },
    { q: 'respondent_consent_status', t: 'household_profile.identity_location.respondent_consent_status', cast: 'direct' },

    // Demographics
    { q: 'total_household_members', t: 'household_profile.demographics.total_household_members', cast: 'cast_number' },
    { q: 'male_members', t: 'household_profile.demographics.male_members', cast: 'cast_number' },
    { q: 'female_members', t: 'household_profile.demographics.female_members', cast: 'cast_number' },
    { q: 'children_0_17', t: 'household_profile.demographics.children_0_17', cast: 'cast_number' },
    { q: 'youth_18_29', t: 'household_profile.demographics.youth_18_29', cast: 'cast_number' },
    { q: 'elderly_60_plus', t: 'household_profile.demographics.elderly_60_plus', cast: 'cast_number' },
    { q: 'female_headed_household', t: 'household_profile.demographics.female_headed_household', cast: 'direct' },
    { q: 'idp_status', t: 'household_profile.demographics.idp_status', cast: 'direct' },
    { q: 'idp_reason', t: 'household_profile.demographics.idp_reason', cast: 'direct' },
    { q: 'education_level_of_head', t: 'household_profile.demographics.education_level_of_head', cast: 'direct' },
    { q: 'employment_status', t: 'household_profile.demographics.employment_status', cast: 'direct' },

    // Livelihood
    { q: 'primary_livelihood_type', t: 'household_profile.livelihood_economy.primary_livelihood_type', cast: 'direct' },
    { q: 'secondary_livelihood_type', t: 'household_profile.livelihood_economy.secondary_livelihood_type', cast: 'direct' },
    { q: 'household_income_level', t: 'household_profile.livelihood_economy.household_income_level', cast: 'direct' },
    { q: 'small_business_ownership', t: 'household_profile.livelihood_economy.small_business_ownership', cast: 'direct' },
    { q: 'small_business_type', t: 'household_profile.livelihood_economy.small_business_type', cast: 'direct' },
    { q: 'daily_labour_dependency', t: 'household_profile.livelihood_economy.daily_labour_dependency', cast: 'direct' },
    { q: 'income_disruption_by_disaster', t: 'household_profile.livelihood_economy.income_disruption_by_disaster', cast: 'direct' },
    { q: 'insurance_coverage', t: 'household_profile.livelihood_economy.insurance_coverage', cast: 'direct' },
    { q: 'access_to_credit_safety_nets', t: 'household_profile.livelihood_economy.access_to_credit_safety_nets', cast: 'direct' },

    // Housing
    { q: 'wall_material_type', t: 'household_profile.housing_physical_conditions.wall_material_type', cast: 'direct' },
    { q: 'roof_material_type', t: 'household_profile.housing_physical_conditions.roof_material_type', cast: 'direct' },
    { q: 'building_age_years', t: 'household_profile.housing_physical_conditions.building_age_years', cast: 'cast_number' },
    { q: 'building_code_compliance', t: 'household_profile.housing_physical_conditions.building_code_compliance', cast: 'direct' },
    { q: 'informal_settlement', t: 'household_profile.housing_physical_conditions.informal_settlement', cast: 'direct' },
    { q: 'sleeping_rooms', t: 'household_profile.housing_physical_conditions.sleeping_rooms', cast: 'cast_number' },
    { q: 'fire_resistant_materials', t: 'household_profile.housing_physical_conditions.fire_resistant_materials', cast: 'direct' },
    { q: 'proximity_to_hazard_zone', t: 'household_profile.housing_physical_conditions.proximity_to_hazard_zone', cast: 'direct' },
    { q: 'drainage_water_electricity_access', t: 'household_profile.housing_physical_conditions.drainage_water_electricity_access', cast: 'direct' },

    // Preparedness
    { q: 'knows_nearest_emergency_shelter', t: 'household_profile.preparedness.knows_nearest_emergency_shelter', cast: 'direct' },
    { q: 'knows_local_evacuation_route', t: 'household_profile.preparedness.knows_local_evacuation_route', cast: 'direct' },
    { q: 'drm_training_received_type', t: 'household_profile.preparedness.drm_training_received_type', cast: 'direct' },
    { q: 'family_emergency_plan_exists', t: 'household_profile.preparedness.family_emergency_plan_exists', cast: 'direct' },
    { q: 'emergency_supplies_stockpiled', t: 'household_profile.preparedness.emergency_supplies_stockpiled', cast: 'direct' },
    { q: 'early_warning_received_channel', t: 'household_profile.preparedness.early_warning_received_channel', cast: 'direct' },
    { q: 'community_awareness_self_rated_1_5', t: 'household_profile.preparedness.community_awareness_self_rated_1_5', cast: 'cast_number' },

    // Recovery Capacity
    { q: 'past_disaster_experience_type', t: 'household_profile.recovery_capacity.past_disaster_experience_type', cast: 'direct' },
    { q: 'recovery_duration_months', t: 'household_profile.recovery_capacity.recovery_duration_months', cast: 'cast_number' },
    { q: 'self_help_savings_group_membership', t: 'household_profile.recovery_capacity.self_help_savings_group_membership', cast: 'direct' },
    { q: 'government_safety_net_access', t: 'household_profile.recovery_capacity.government_safety_net_access', cast: 'direct' },
    { q: 'income_diversification_2plus_sources', t: 'household_profile.recovery_capacity.income_diversification_2plus_sources', cast: 'direct' },
    { q: 'resilience_enumerator_assessment_1_5', t: 'household_profile.recovery_capacity.resilience_enumerator_assessment_1_5', cast: 'cast_number' }
  ];
  ...
  const mapping = {
    ...
    description: '1-to-1 profile mapping matching the premium Household Assessment Questionnaire fields directly into the structured WoredaProfile model.',
